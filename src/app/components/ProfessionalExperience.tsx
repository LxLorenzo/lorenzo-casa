  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 justify-center items-center">
        <div className="sm:p-6 flex justify-center sm:items-center gap-5 rounded-md hover:bg-zinc-100 transition shadow-md border border-primary p-5 dark:border-zinc-50 dark:hover:bg-neutral-900 max-w-[768px] w-full">
